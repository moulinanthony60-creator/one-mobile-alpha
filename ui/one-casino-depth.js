...
#onePointsPanel .oneSlotArt{display:block;width:100%;height:100%;background-image:url('ui/one-slot-symbols-real.png?v=014101');background-size:300% 200%;background-repeat:no-repeat}
...
#onePointsPanel .oneCabinetTop{height:77px;position:relative;border:3px solid #373ef6;border-left-color:#7f97ff;border-right-color:#c73dfa;box-shadow:0 0 7px #9b63ff,inset 0 0 10px #07348c;background:url('ui/one-slot-dragon-banner.png?v=014101') center 42%/cover;border-radius:5px;margin:0 0 6px}
