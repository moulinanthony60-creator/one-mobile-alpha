...
0.13.20 : 17 scripts validés. Tests simulés : iframe créée une seule fois, autoplay muet, chat agrandi/réduit même si Fullscreen API refuse. Pas de test réel mobile ou session Twitch.

0.13.20 : 18 scripts validés ; tests simulés ouverture par bulle, bonne chaîne, disposition partagée et restauration sans recréer le lecteur. Régression réussie. Plein écran physique, zones système et rendu mobile à valider sur appareil.

0.13.20 : suppression ciblée du paragraphe vérifiée, scripts validés. Aucun changement aux interactions Twitch.
