...
(()=>{const style=document.createElement('style');style.textContent="#onePointsPanel .oneCardReverse{overflow:hidden;isolation:isolate;background:radial-gradient(circle at 50% 34%,#65498e 0 8%,transparent 9%),radial-gradient(circle at 50% 34%,transparent 0 23%,#d7b56b 24% 25%,transparent 26%),repeating-conic-gradient(from 8deg,#2d173f 0 8deg,#48245c 8deg 16deg),linear-gradient(145deg,#1a1028,#56326f 52%,#180e27);box-shadow:inset 0 0 0 4px #191021,inset 0 0 0 6px #e7c979,inset 0 0 28px #c57cff55,0 8px 18px #0009;color:#ffe49a;text-shadow:0 2px 0 #2a1638,0 0 14px #ffd77899;letter-spacing:4px}#onePointsPanel .oneCardReverse::before{content:\"\";position:absolute;inset:12px;border:1px solid #f8e0a677;border-radius:9px;background:linear-gradient(135deg,#ffffff22,transparent 30%,transparent 70%,#ffffff18);transform:rotate(45deg);animation:oneBackSweep 3.4s ease-in-out infinite}#onePointsPanel .oneCardReverse::after{position:relative;z-index:2;font-weight:800;letter-spacing:2px}#onePointsPanel .oneCardReverse span{position:relative;z-index:2;font-size:42px;color:#ffe89b;filter:drop-shadow(0 0 8px #ffcf6d99);animation:oneBackStar 2.4s ease-in-out infinite}#onePointsPanel .oneCardReverse{font-size:19px;font-family:Georgia,serif}#onePointsPanel .oneCard3d.isUnrevealed .oneCardReverse{animation:oneBackPulse 2.2s ease-in-out infinite}#onePointsPanel .onePackReveal .oneCard3d.isUnrevealed .oneCardRotor{transition:transform 1s cubic-bezier(.16,.84,.28,1)}@keyframes oneBackSweep{0%,100%{translate:-18% 0;opacity:.25}50%{translate:18% 0;opacity:.8}}@keyframes oneBackStar{0%,100%{transform:scale(.9) rotate(-8deg);opacity:.82}50%{transform:scale(1.12) rotate(8deg);opacity:1}}@keyframes oneBackPulse{0%,100%{filter:drop-shadow(0 0 0 #bc7cff00)}50%{filter:drop-shadow(0 0 11px #bd7cff88)}}@media(prefers-reduced-motion:reduce){#onePointsPanel .oneCardReverse::before,#onePointsPanel .oneCardReverse span,#onePointsPanel .oneCard3d.isUnrevealed .oneCardReverse{animation:none}}";document.head.append(style)})();
