const CACHE='one-mobile-alpha-1474-compact-cards-twitch-v1';
const CORE=['./ui/icons.js?v=01474','./ui/foundation.css?v=01474','./ui/foundation.js?v=01474','./','./index.html','./manifest.json','./manifest.webmanifest','./privacy.html','./terms.html','./icon-192.png','./icon-512.png'];
