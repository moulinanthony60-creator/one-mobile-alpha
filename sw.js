const CACHE='one-mobile-alpha-14105-mobile-ux';
const CORE=['./ui/mobile-ux.js?v=014105','./ui/mobile-ux.css?v=014105','./ui/connections.js?v=014105','./ui/icons.js?v=014105','./ui/foundation.css?v=014105','./ui/foundation.js?v=014105','./','./index.html','./manifest.json','./manifest.webmanifest','./privacy.html','./terms.html','./icon-192.png','./icon-512.png'];
