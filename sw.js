const CACHE='one-mobile-alpha-1449-compact-cards-twitch-v1';
const CORE=['./ui/icons.js?v=01449','./ui/foundation.css?v=01449','./ui/foundation.js?v=01449','./','./index.html','./manifest.json','./manifest.webmanifest','./privacy.html','./terms.html','./icon-192.png','./icon-512.png'];
