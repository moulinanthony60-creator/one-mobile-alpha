const CACHE='one-mobile-alpha-1496-scratch-cards-v34';
const CORE=['./ui/icons.js?v=01496','./ui/foundation.css?v=01496','./ui/foundation.js?v=01496','./','./index.html','./manifest.json','./manifest.webmanifest','./privacy.html','./terms.html','./icon-192.png','./icon-512.png'];
