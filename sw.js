const CACHE='one-mobile-alpha-14102-party-poker-v37';
const CORE=['./ui/icons.js?v=014102','./ui/foundation.css?v=014102','./ui/foundation.js?v=014102','./','./index.html','./manifest.json','./manifest.webmanifest','./privacy.html','./terms.html','./icon-192.png','./icon-512.png'];
