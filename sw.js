const CACHE='one-mobile-alpha-1412-compact-cards-twitch-v1';
const CORE=['./ui/icons.js?v=01412','./ui/foundation.css?v=01412','./ui/foundation.js?v=01412','./','./index.html','./manifest.json','./manifest.webmanifest','./privacy.html','./terms.html','./icon-192.png','./icon-512.png'];
