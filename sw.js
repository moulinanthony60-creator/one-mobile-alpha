const CACHE='one-mobile-alpha-1454-compact-cards-twitch-v1';
const CORE=['./ui/icons.js?v=01454','./ui/foundation.css?v=01454','./ui/foundation.js?v=01454','./','./index.html','./manifest.json','./manifest.webmanifest','./privacy.html','./terms.html','./icon-192.png','./icon-512.png'];
