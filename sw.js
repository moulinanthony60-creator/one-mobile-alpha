const CACHE='one-mobile-alpha-1493-scratch-cards-v32';
const CORE=['./ui/icons.js?v=01493','./ui/foundation.css?v=01493','./ui/foundation.js?v=01493','./','./index.html','./manifest.json','./manifest.webmanifest','./privacy.html','./terms.html','./icon-192.png','./icon-512.png'];
