const CACHE='one-mobile-alpha-1495-scratch-cards-v33';
const CORE=['./ui/icons.js?v=01495','./ui/foundation.css?v=01495','./ui/foundation.js?v=01495','./','./index.html','./manifest.json','./manifest.webmanifest','./privacy.html','./terms.html','./icon-192.png','./icon-512.png'];
