const CACHE='one-mobile-alpha-14103-party-flow-v37';
const CORE=['./ui/icons.js?v=014103','./ui/foundation.css?v=014103','./ui/foundation.js?v=014103','./','./index.html','./manifest.json','./manifest.webmanifest','./privacy.html','./terms.html','./icon-192.png','./icon-512.png'];
