const CACHE='one-mobile-alpha-1400-compact-cards-twitch-v1';
const CORE=['./ui/foundation.css?v=01400','./ui/foundation.js?v=01400','./','./index.html','./manifest.json','./manifest.webmanifest','./privacy.html','./terms.html','./icon-192.png','./icon-512.png'];
