const CACHE='one-mobile-alpha-1445-compact-cards-twitch-v1';
const CORE=['./ui/icons.js?v=01445','./ui/foundation.css?v=01445','./ui/foundation.js?v=01445','./','./index.html','./manifest.json','./manifest.webmanifest','./privacy.html','./terms.html','./icon-192.png','./icon-512.png'];
