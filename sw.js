const CACHE='one-mobile-alpha-1498-rewards-gems-v35';
const CORE=['./ui/icons.js?v=01498','./ui/foundation.css?v=01498','./ui/foundation.js?v=01498','./','./index.html','./manifest.json','./manifest.webmanifest','./privacy.html','./terms.html','./icon-192.png','./icon-512.png'];
