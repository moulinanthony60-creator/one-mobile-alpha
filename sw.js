const CACHE='one-mobile-alpha-1499-scratch-odds-v36';
const CORE=['./ui/icons.js?v=01499','./ui/foundation.css?v=01499','./ui/foundation.js?v=01499','./','./index.html','./manifest.json','./manifest.webmanifest','./privacy.html','./terms.html','./icon-192.png','./icon-512.png'];
