const CACHE='one-mobile-alpha-1494-scratch-cards-v33';
const CORE=['./ui/icons.js?v=01494','./ui/foundation.css?v=01494','./ui/foundation.js?v=01494','./','./index.html','./manifest.json','./manifest.webmanifest','./privacy.html','./terms.html','./icon-192.png','./icon-512.png'];
