const CACHE='one-mobile-alpha-1416-compact-cards-twitch-v1';
const CORE=['./ui/icons.js?v=01416','./ui/foundation.css?v=01416','./ui/foundation.js?v=01416','./','./index.html','./manifest.json','./manifest.webmanifest','./privacy.html','./terms.html','./icon-192.png','./icon-512.png'];
