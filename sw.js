const CACHE='one-mobile-alpha-1340-tiktok-audio-manual-fs-v1';
const CORE=['./','./index.html','./manifest.json','./manifest.webmanifest','./privacy.html','./terms.html','./icon-192.png','./icon-512.png'];
