const CACHE='one-mobile-alpha-14104-connections-v1';
const CORE=['./ui/connections.js?v=014104','./ui/icons.js?v=014104','./ui/foundation.css?v=014104','./ui/foundation.js?v=014104','./','./index.html','./manifest.json','./manifest.webmanifest','./privacy.html','./terms.html','./icon-192.png','./icon-512.png'];
