CREATE TABLE IF NOT EXISTS one_casino(account_id TEXT NOT NULL,id TEXT NOT NULL,kind TEXT NOT NULL,stake INTEGER NOT NULL CHECK(stake>0 AND stake<=5000),state TEXT NOT NULL,settled INTEGER NOT NULL DEFAULT 0,payout INTEGER NOT NULL DEFAULT 0,version INTEGER NOT NULL DEFAULT 0,PRIMARY KEY(account_id,id));
